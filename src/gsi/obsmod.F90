...
! set subroutines and functions to public
  ...
  public :: if_cs_staticB,adaptive_hybrid
...
! Declare global variables
  ...
  logical if_cs_staticB ! ywang
  logical adaptive_hybrid ! ywang
...
!   set default on diag writing
    ...
    if_cs_staticB      = .false.  ! ywang .true. = use the convective-scale static BEC
